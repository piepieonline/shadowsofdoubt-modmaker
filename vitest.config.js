 ...
 * deciding what a tool does to a node. The Playwright suites in tests/ and e2e/ keep
 * everything that needs a real page -- see the README for the line between them.
 *
...
export default defineConfig({
    test: {
        ...
        setupFiles: ['./test-support/refs.js', './test-support/jsonpatch.js'],
    },
});
